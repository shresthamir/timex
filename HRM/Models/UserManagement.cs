...
namespace HRM.Models
{
    class UserManagement : RootModel, IDataErrorInfo
    {
        ...
        private bool _DEVICE_TIME_SYNC;
        private bool _DEVICE_ENAME_SYNC;
        #endregion
        ...
        public bool DEVICE_ENAME_SYNC { get { return _DEVICE_ENAME_SYNC; } set { _DEVICE_ENAME_SYNC = value; OnPropertyChanged("DEVICE_ENAME_SYNC"); } }
        public bool DEVICE_TIME_SYNC { get { return _DEVICE_TIME_SYNC; } set { _DEVICE_TIME_SYNC = value; OnPropertyChanged("DEVICE_TIME_SYNC"); } }
        #endregion
...
DEVICE_TIME_SYNC, DEVICE_ENAME_SYNC)
...
@ANNUAL_HOLIDAY_LIST, @ATTENDANCE_LOG, @DAILY_ATTENDANCE_LOG, @MONTHLY_ATTENDANCE_LOG, @COMPANY_INFO, @DOWNLOAD_ATTENDANCE_DATA, @DATA_BACKUP, @DATA_RESTORE, @DEVICE_SETTING, @INACTIVE, @ASSIGN_WORKHOUR,
@DEVICE_TIME_SYNC, @DEVICE_ENAME_SYNC)", this, tran) == 1;
        }
...
DEVICE_TIME_SYNC = @DEVICE_TIME_SYNC, DEVICE_ENAME_SYNC = @DEVICE_ENAME_SYNC
